...
Event character matters more than the aggregate. COVID-19 was an acute but recoverable shock (sharp drop, fast rebound), whereas the Global Financial Crisis caused lasting structural damage (slow, incomplete recovery).
Bottom line: Sustainable returns come from structural drivers — concentrated in Technology and Healthcare — not from temporary disruptions in sectors like Energy or Materials.
